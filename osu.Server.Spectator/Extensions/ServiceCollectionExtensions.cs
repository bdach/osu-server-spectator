    ...
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddHubEntities(this IServiceCollection serviceCollection)
        {
            return serviceCollection.AddHttpClient()
                                    ...
                                    .AddSingleton<MultiplayerEventNotifier>()
                                    .AddSingleton<IMultiplayerRoomEventNotifier>(p => p.GetRequiredService<MultiplayerEventNotifier>())
                                    .AddSingleton<IMatchmakingEventNotifier>(p => p.GetRequiredService<MultiplayerEventNotifier>())
