...
namespace osu.Server.Spectator.Tests.Multiplayer
{
    ...
    public abstract class MultiplayerTest
    {
        ...
        protected MultiplayerTest()
        {
            ...
            Receiver.Setup(c => c.Clients).Returns(getClientsForGroup(MultiplayerEventNotifier.GetGroupId(ROOM_ID)));

            Receiver2 = new Mock<DelegatingMultiplayerClient> { CallBase = true };
            Receiver2.Setup(c => c.Clients).Returns(getClientsForGroup(MultiplayerEventNotifier.GetGroupId(ROOM_ID_2)));
            ...
            Clients.Setup(clients => clients.Group(MultiplayerEventNotifier.GetGroupId(ROOM_ID))).Returns(Receiver.Object);
            Clients.Setup(clients => clients.Group(MultiplayerEventNotifier.GetGroupId(ROOM_ID_2))).Returns(Receiver2.Object);
